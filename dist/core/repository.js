    ...
    _createClass(RepositoryModel, [{
        ...
        value: function related(opt) {
            ...
            return this.client.http_get('api', path, opt).then(function (data) {
                ...
                }, _this.client, path, data, undefined, opt);
            });
        }
    }, {
        key: 'branches',
        value: function branches(opt) {
            ...
            return this.client.http_get('api', path, opt).then(function (data) {
                return new _clientBase.DefaultPagedResponse(_this2.client, path, data, undefined, opt);
            });
        }
    }, {
        key: 'default_branch',
        ...
        value: function changes(opt) {
            ...
            return this.client.http_get('api', path, opt).then(function (data) {
                ...
                }, _this3.client, path, data, undefined, opt);
            });
        }
    }, {
        key: 'commits',
        value: function commits(opt) {
            ...
            return this.client.http_get('api', path, opt).then(function (data) {
                ...
                }, _this4.client, path, data, undefined, opt);
            });
        }
    }, {
        key: 'commit',
        ...
        value: function files(opt) {
            ...
            return this.client.http_get('api', path, opt).then(function (data) {
                return new _clientBase.DefaultPagedResponse(_this5.client, path, data, undefined, opt);
            });
        }
    }, {
        key: 'browse',
        value: function browse(opt) {
            ...
            return this.client.http_get('api', path.toString(), opt).then(function (data) {
                return new _clientBase.DefaultPagedResponse(_this6.client, path, data, 'lines', opt);
            });
        }
    }, {
        key: 'pull_requests',
        value: function pull_requests(opt) {
            ...
            return this.client.http_get('api', path, opt).then(function (data) {
                ...
                }, _this7.client, path, data, undefined, opt);
            });
        }
    }, {
        key: 'pull_request',
        ...
        key: 'tags',
        value: function tags(opt) {
            var _this9 = this;

            var path = '/projects/' + this.project.key + '/repos/' + this.slug + '/tags';
            return this.client.http_get('api', path, opt).then(function (data) {
                return new _clientBase.PagedResponse(function (c, d) {
                    return new _tag2['default'](d);
                }, _this9.client, path, data, undefined, opt);
            });
        }
    }]);
