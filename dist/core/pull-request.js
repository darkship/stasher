...
var _buildStatus2 = _interopRequireDefault(_buildStatus);
    ...
    _createClass(PullRequestModel, [{
        ...
        value: function commits(opt) {
            ...
            return this.client.http_get('api', path, opt).then(function (data) {
                ...
                }, _this2.client, path, data, undefined, opt);
            });
        }
    }, {
        key: 'diff',
        ...
        value: function buildStatus() {
            ...
            return this.client.http_get('build-status', '/commits/' + this.fromRef.latestChangeset).then(function (data) {
                return new _clientBase.PagedResponse(function (c, d) {
                    return new _buildStatus2['default'](c, d);
                }, _this3.client, 'commits', data, 'values');
            });
        }
    }]);
